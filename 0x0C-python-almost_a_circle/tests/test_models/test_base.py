...
class TestBase_init(unittest.TestCase):
    ...
    def test_no_arg_4_3_bases(self):
        b1 = Base()
        b2 = Base()
        b3 = Base()
    ...
    def test_string_id(self):
        self.assertEqual(Base("Base").id, "Base")

    def test_dict_id(self):
        self.assertEqual(Base({"key": "value"}).id, {"key": "value"})
...
class TestBase_to_json_string(unittest.TestCase):
    """Unittest to test to_json_string methods in Base class"""
